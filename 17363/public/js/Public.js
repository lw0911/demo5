    ...
    if($(document).find(".aniBoxs").length>0){
    	$(".aniBoxs").find(".aniBox").each(function(i,e){
    		...
    		$(e).find(".tips").hover(function(){
	    			$(this).stop().animate({"opacity":1,"width":263,"height":263},"fast");
	    			$(this).find(".tcontent").stop().animate({"opacity":1,"width":260,"height":260},"fast");
//	    			$(this).find(".tcontent1").stop().animate({"opacity":1,"width":263,"height":263},"fast");
//	    			$(this).find(".tcontent").css("padding",10);
