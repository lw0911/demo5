$(function(){
	...
	$.ajax({
		url:"../storejson/store.json"/*tpa=http://www.zhouheiya.cn/wcs/Tpl/home/default/storejson/store.json*/,
		dataType: "json",
	...
	function findPlace(obj, level, cur){
		...
		if(level_len == 4){
			...
			$.ajax({
				//url:"http://www.zhouheiya.cn/wcs/Tpl/home/default/js/js/test2.json", //console.log(level.join('-'))
