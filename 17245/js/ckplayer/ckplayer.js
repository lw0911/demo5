...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
        advmarquee: escape('{a href="http://www.ckplayer.com"}{font color="#FFFFFF" size="12" face="Microsoft YaHei"}产品名称（产品网）成立于2008年；是一家专业从事Linux路由、认证计费、缓存系统、IPTV系统、VOD系统开发的专业科技公司。{/font}{/a}'),
        /*
