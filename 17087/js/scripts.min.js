...
/* WEBPACK VAR INJECTION */(function($) {$(function(){
  ...
  sendBtn2.on('click', function () {
    ...
    if(name.length == 0){
      layer.msg('您好, 请输入您的用户名', function(){
        return false;
      });
      return false;
    }
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        $.ajax({
          url: '',
          type: 'post',
          data: "username=" + name + "&password=" + pass + "&mobile=" + tel + "&email=test@qq.com&qq=11111111",
  ...
  $('.development-slider').unslider({
      ...
      nav: function (index, label) {
          ...
          return '<i></i><span>' + (index + 2003) + '</span><br />' + (index + 2003);
      },
      index: 11,
      animation: 'fade',
      arrows: false
