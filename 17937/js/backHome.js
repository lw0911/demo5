...
function fullScreenClick(){
    ...
    var win_h = $(parent.document.body).find(".frameMenu").height() + 50;
...
function merchantGraph(id,data){
    ...
    var option = {
	    ...
	    tooltip: {
			...
			formatter: function (p) {
                return '<font style="display: block; text-align: right;font-size: 18px; font-weight: 600; line-height: 18px;">'+get_thousand_num(p.value)+'</font><span style="width: 100%; display: block; overflow: hidden;"><span style="display: block; float: right; width: 40px; height:4px; border-radius: 2px; background-color: #6884f4; margin-top: 10px; margin-bottom: 8px;"></span></span><font style="float:right; font-size: 14px; line-height: 14px;">'+p.name+ MERCHANTGRAPH_TAG +'</font>';
			}
	    },
	    //直角坐标系内绘图网格
	    grid: {
...
function orderMap(id,data){
    ...
    var option = {
	    ...
	    tooltip: {
			...
			formatter: function (p) {
			    return '<font style="font-size:18px">'+get_thousand_num(p.value)+'</font> <font style="font-size:12px">单</font><span style="display: block; width: 45px; height:4px; border-radius: 2px; background-color: #199d8b;"></span>'+p.name+":00";
			}
	    },
...
function weekActive(id,data){
    ...
    var option = {
        ...
        color:['#d8ddff','#5371c5','#be6256'],	//调色盘颜色列表
	    legend: {
	    	top: 18,
	    	right: 0,
	    	textStyle: {
	    ...
	    series : [
	        {
	            ...
	            areaStyle: {	//区域填充样式
	            	color: {
					    ...
					    y2: 1,
					    colorStops: [{
					        offset: 0, color: '#c9eeff' // 0% 处的颜色
					    }, {
					        offset: 1, color: '#b1b9ff' // 100% 处的颜色
					    }],
					    globalCoord: false // 缺省为 false
					}
	           	},
	        ...
	        },
	        {
	            ...
	            areaStyle: {	//区域填充样式
	            	color: {
					    ...
					    y2: 1,
					    colorStops: [{
					        offset: 0, color: '#1e9996' // 0% 处的颜色
					    }, {
					        offset: 1, color: '#7d52e9' // 100% 处的颜色
					    }],
					    globalCoord: false // 缺省为 false
					}
	           	},
	        ...
	        },
	        {
	            ...
	            areaStyle: {	//区域填充样式
	            	color: {
					    ...
					    y2: 1,
					    colorStops: [{
					        offset: 0, color: '#fcbc70' // 0% 处的颜色
					    }, {
					        offset: 1, color: '#fd5d4c' // 100% 处的颜色
					    }],
					    globalCoord: false // 缺省为 false
					}
	           	},
	    ...
	    series: [
	        {
	            ...
	            areaStyle: {	//区域填充样式
	            	color: {
					    ...
					    y2: 0,
					    colorStops: [{
					        offset: 0, color: '#169e84' // 0% 处的颜色
					    }, {
					        offset: 1, color: '#2596a6' // 100% 处的颜色
					    }],
					    globalCoord: false // 缺省为 false
					},
                    opacity: 0.6,
