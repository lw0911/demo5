var LR_sysurl = 'http://kmj.zoossoft.net/';
var LR_siteid = '29171670';
var LR_imgurl = 'http://kmj.zoossoft.net/';
if(typeof(LR_showfloat)=='undefined' || LR_showfloat!=1)var LR_showfloat = 1;
var LiveReceptionCode_isonline = 1;
var LR_62529='048D27FBA4314F12B9CFF519E16B8855';var LR_js_pm = 'd';
var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_ssl = 0;
var LR_isMobile = 0;
var LR_websiteid = 'KMJ29171670';
var LR_47e4a=LR_62529.replace(/1/g,'3').replace(/0/g,'2');var LR_lng = 'cn';
var LR_589b3=LR_47e4a.replace(/1/g,'3').replace(/0/g,'2');var LR_CDKF=LR_589b3.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_helpsrc_on=unescape("http%3a%2f%2fkmj.zoossoft.net%2flr%2fimages%2fonline_cn48.gif");
	...
	var _lr_helpsrc_of=unescape("http%3a%2f%2fkmj.zoossoft.net%2flr%2fimages%2foffline_cn38.gif");
	...
	LR_hasInstall=0;
	var LR_ivite_img='http://put.zoosnet.net/js/tj_blue/p.gif';
	...
	var _lr_invitestring=unescape("%3cP style%3d%22FONT-SIZE%3a 9pt%22 align%3dcenter%3e%3cSTRONG%3e%3cFONT color%3d%23ff0000%3e%u6b22%u8fce%u6765%u5230%u5317%u4eac%u5927%u5b66%u76f4%u5c5e%u6559%u80b2%u673a%u6784%3cBR%3e%u5317%u5927%u9752%u9e1f%u5b98%u65b9%u7f51%u7ad9%uff01%3cBR%3e%3c%2fFONT%3e%3c%2fSTRONG%3e%3c%2fP%3e");
	...
	var LR_invitestring1_auto=unescape("%3cP align%3dcenter%3e%u6b22%u8fce%u8bbf%u95ee%u5317%u5927%u9752%u9e1f%u5b98%u65b9%u7f51%u7ad9%3cBR%3e%u66f4%u591a%u8be6%u60c5%u8bf7%u70b9%u51fb%u54a8%u8be2%3cBR%3e%3c%2fP%3e");
	...
	var LR_pm011=0;
	var LR_pm012=30;
	function minichathtml(islrminimin) {return '<div style=\"width:400px; height:390px;'+(islrminimin?'display:none;':'')+'\" id=\"LRMINIWIN\"><div id=\"LRMINIWIN0\" style=\"z-index:2147483647;POSITION:absolute;margin-left:0px;width:400px;height:40px;overflow:hidden;\"><span style=\"float:left;clear:none; width:150px;height:30px; overflow:hidden; margin:0 5px;padding-top: 10px;padding-left: 180px;\"><img src=\"http://kmj.zoossoft.net/site/customwin/mini/tel.png\"/></span><span style=\"CURSOR:pointer;float:right;clear:none; width:20px;height:20px; margin:8px 0 0 0; overflow:hidden;\" onclick=\"lr_closemini();\"><img style=\"cursor:pointer;padding-top: 3px;\" src=\"http://kmj.zoossoft.net/site/customwin/mini/close.png\" border=\"0\"></span><span style=\"CURSOR:pointer;float:right;overflow:hidden;width:20px;height:20px;clear:none;display:bolck;margin:8px 0 0 0;\" onclick=\"openZoosUrl(\'bchatwin\');lr_hidemini();\"><img src=\"http://kmj.zoossoft.net/site/customwin/mini/big.png\" style=\"cursor:pointer;padding-top: 3px;\"  border=\"0\"></span><span style=\"CURSOR:pointer;float:right;overflow:hidden;width:20px;height:20px;clear:none;display:bolck;margin:8px 0 0 0;\" onclick=\"lrminiMin();\"><img src=\"http://kmj.zoossoft.net/site/customwin/mini/small.png\" style=\"cursor:pointer;padding-top: 8px;\"  border=\"0\"></span><span style=\"CURSOR:pointer;float:right;overflow:hidden;width:20px;height:20px;clear:none;display:none;margin:8px 0 0 0;\" onclick=\"lrmove();\"><img src=\"" style=\"cursor:pointer;\" border=\"0\"></span></div><iframe id=\"LR_miniframe\" name=\"LR_miniframe\" width=\"100%\" height=\"390px\" frameborder=\"0\" scrolling=\"No\" allowtransparency=\"true\" src=\"' + LR_sysurl +'JS/im1.aspx\"></iframe></div>';}
	function minibarhtml(islrminimin) {return '<div id=\"LRMINIBar\" onclick=\"lrminiMax();document.getElementById(\'LRMINIWIN\').style.width =\'400px\';\" style=\"'+(!islrminimin?'display:none;':'')+'width: 193px;height: 30px;line-height: 30px;font-size: 13px;font-family:Arial;color:#fff;cursor: pointer;\"><div style=\"width:400px; height:35px; background:url(http://kmj.zoossoft.net/site/customwin/mini/huihua.png) no-repeat; position:fixed; right:0; bottom:0;\"><a style=\"position:absolute; top:12px; right:20px;\" href=\"#\"><img src=\"http://kmj.zoossoft.net/site/customwin/mini/dao3.png\"/></a></div></div>';}
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NFAC='+LR_CDKF;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://kmj.zoossoft.net/js/JS5.css" rel="stylesheet" type="text/css" />');
...
function lr_useraa() {if (typeof (openZoosUrl) != 'function') {setTimeout('lr_useraa()', 100);return;} if(!LR_isMobile){LR_UserInviteDiv = '<div id="swtbox" style="width:570px; height:228px; background:url(http://zs.bdqn.cn/swtyq/yaoqing.png); overflow:hidden; position:relative"><div id="swtchat" style="width: 570px; height: 228px; top: 0px; right: 0px; z-index: 1; position: absolute"><a href="" onclick="{0}return false;" style="display:block; text-indent:-999em;width:570px; height:228px;"></a></div><div style="z-index: 2; top: 118px; right: 14px; position: absolute; width: 75px; height: 25px;"><a href="javascript:void(0)" onclick="{1}return false;" style="display:block; text-indent:-999em; width: 75px; height: 25px;"></a></div></div>';}}lr_useraa();if(!LR_isMobile){LR_above_flash=0;var lr_xCenter = 285;var lr_yCenter = 114;}}
