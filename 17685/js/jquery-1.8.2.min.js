...
function(e, t) {
    ...
    function k(e, n, r, i, o, a) {
        ...
        a = a || {},
        a[o] = !0;
        for (var s, l = e[o], u = 0, c = l ? l.length: 0, f = e === qn; c > u && (f || !s); u++) s = l[u](n, r, i),
    ...
    function O(e, t, n) {
        ...
        1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], "inline" === K.css(e, "display") && "none" === K.css(e, "float") && (K.support.inlineBlockNeedsLayout && "inline" !== T(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
        n.overflow && (p.overflow = "hidden", K.support.shrinkWrapBlocks || f.done(function() {
    ...
    K.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            function(n) {
                ...
                a = K(this), s = t, l = e.split(tt); i = l[o++];) s = r ? s: !a.hasClass(i),
        ...
        valHooks: {
            ...
            select: {
                get: function(e) {
                    ...
                    l = "select-one" === e.type;
                    if (0 > o) return null;
                    for (n = l ? o: 0, r = l ? o + 1 : s.length; r > n; n++) if (i = s[n], !(!i.selected || (K.support.optDisabled ? i.disabled: null !== i.getAttribute("disabled")) || i.parentNode.disabled && K.nodeName(i.parentNode, "optgroup"))) {
    ...
    K.event = {
        add: function(e, n, r, i, o) {
            ...
            if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = K._data(e))) {
                ...
                s.elem = e), n = K.trim(Ft(n)).split(" "), u = 0; u < n.length; u++) c = At.exec(n[u]) || [],
                f = c[1],
                p = (c[2] || "").split(".").sort(),
                m = K.event.special[f] || {},
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (m && (p = m.events)) {
                for (t = K.trim(Ft(t || "")).split(" "), o = 0; o < t.length; o++) if (a = At.exec(t[o]) || [], s = l = a[1], u = a[2], s) {
    ...
    function(e, t) {
        ...
        Dt.test(t) && (K.event.fixHooks[t] = K.event.keyHooks),
        Lt.test(t) && (K.event.fixHooks[t] = K.event.mouseHooks)
    }),
    function(e, t) {
        function n(e, t, n, r) {
            n = n || [],
            ...
            if (a = w(t), !a && !r && (i = nt.exec(e))) if (s = i[1]) {
                ...
                n;
                if ((s = i[3]) && pt && t.getElementsByClassName) return _.apply(n, q.call(t.getElementsByClassName(s), 0)),
                n
            }
        ...
        function s(e, t) {
            ...
            for (s = e, l = [], u = b.preFilter; s;) { (!r || (i = Z.exec(s))) && (i && (s = s.slice(i[0].length)), l.push(o = [])),
                r = !1,
                (i = et.exec(s)) && (o.push(r = new D(i.shift())), s = s.slice(r.length), r.type = i[0].replace(Q, " "));
                for (a in b.filter)(i = st[a].exec(s)) && (!u[a] || (i = u[a](i, L, !0))) && (o.push(r = new D(i.shift())), s = s.slice(r.length), r.type = a, r.matches = i);
                if (!r) break
            }
        ...
        function f(e, t, n, r, i, o) {
            ...
            W(function(o, a, s, l) {
                if (!o || !i) {
                    ...
                    b = n ? i || (o ? e: m || r) ? [] : a: v;
                    if (n && n(v, b, s, l), r) for (p = c(b, g), r(p, [], s, l), u = p.length; u--;)(f = p[u]) && (b[g[u]] = !(v[g[u]] = f));
                    if (o) for (u = e && b.length; u--;)(f = b[u]) && (o[d[u]] = !(a[d[u]] = f));
        ...
        n.uniqueSort = function(e) {
            var t, n = 1;
            if (k = S, e.sort(C), k) for (; t = e[n]; n++) t === e[n - 1] && e.splice(n--, 1);
            return e
        },
        n.error = function(e) {
    ...
    K.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, r = 0,
            i = this.length,
            o = [], a = qt.test(e) || "string" != typeof e ? K(e, t || this.context) : 0; i > r; r++) for (n = this[r]; n && n.ownerDocument && n !== t && 11 !== n.nodeType;) {
    ...
    K.fn.extend({
        ...
        html: function(e) {
            ...
            function(e) {
                ...
                if (! ("string" != typeof e || Ut.test(e) || !K.support.htmlSerialize && Jt.test(e) || !K.support.leadingWhitespace && Rt.test(e) || Zt[(It.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace($t, "<$1></$2>");
                    try {
                        for (; i > r; r++) n = this[r] || {},
    ...
    K.buildFragment = function(e, n, r) {
        ...
        n = !n.nodeType && n[0] || n,
        n = n.ownerDocument || n,
        1 === e.length && "string" == typeof s && s.length < 512 && n === R && "<" === s.charAt(0) && !Yt.test(s) && (K.support.checkClone || !Gt.test(s)) && (K.support.html5Clone || !Jt.test(s)) && (o = !0, i = K.fragments[s], a = i !== t),
    ...
    K.extend({
        ...
        cleanData: function(e, t) {
            ...
            c = K.event.special; null != (i = e[a]); a++) if ((t || K.acceptData(i)) && (r = i[s], n = r && l[r])) {
    ...
    e.getComputedStyle ? nn = function(t, n) {
        ...
        l = t.style;
        return s && (r = s[n], "" === r && !K.contains(t.ownerDocument, t) && (r = K.style(t, n)), pn.test(r) && cn.test(n) && (i = l.width, o = l.minWidth, a = l.maxWidth, l.minWidth = l.maxWidth = l.width = r, r = s.width, l.width = i, l.minWidth = o, l.maxWidth = a)),
        r
    ...
    K.extend({
        ...
        ajax: function(e, n) {
            ...
            n = n || {};
            var i, o, a, s, l, u, c, f, p = K.ajaxSetup({},
            n),
            d = p.context || p,
            ...
            T = {
                ...
                getResponseHeader: function(e) {
                    var n;
                    if (2 === x) {
                        if (!a) for (a = {}; n = An.exec(o);) a[n[1].toLowerCase()] = n[2];
                        n = a[e.toLowerCase()]
                    }
                    return n === t ? null: n
                },
