(function ($) {
    ...
    $.fn.kkPages2 = function (options) {

        var opts = $.extend({}, $.fn.kkPages2.defaults, options);
        ...
        return this.each(function () {
            ...
            // 定义分页导航
            var PagesNavHtml = "<div class=\"Pagination\"><a href=\"javascript:;\" class=\"homePage\" title=\"首页\"></a><a href=\"javascript:;\" class=\"PagePrev\" title=\"上一页\"></a><div class=\"pagesnum\"></div><div class=\"pagesnum3\"></div><a href=\"javascript:;\" class=\"PageNext\" title=\"下一页\"></a><a href=\"javascript:;\" class=\"lastPage\" title=\"尾页\"></a>";
            ...
            if ($AllMth > $Mth) {
                ...
                //$(".pagesnum2").html("/"+PagesMth);
				$(".pagesnum3").html("/"+PagesMth);
    ...
    $.fn.kkPages2.setDefaults = function (settings) {
        $.extend($.fn.kkPages2.defaults, settings);
    };
