...
(function ($, window, document, undefined)
{
    ...
    _easyinput.prototype = {
        ...
        judge: {
            ...
            "num":function (ei , v , p ) {
                if (false == /\d+$/.test(v))
                    return ei._error("num");
                else
                    return ei._success_rule("num");
            },
            ...
            "rule": function (ei, v, p)
            {
                if (false == /^1[3|4|5|8|7][0-9]\d{8}$/.test(v))
                    return ei._error("rule");
                else
                    return ei._success_rule("rule");
            },
...
(function ($, window, document, undefined)
{
    var themes = {
        ...
        blue: {
            ...
            "background-color": "rgba(191,43,56,0.8)",
            "border": "1px solid rgba(191,43,56,0.8)",
            "border-radius": 5
        },
        red: {
            color: "rgba(255,255,255,1)",
    ...
    _easytip.prototype = {
        ...
        init: function ()
        {
            ...
            if (tip.length == 0)
            {
                $(document.body).append("<div id=\"" + this.id + "\" class=\"easytip-div-alert\"><div class=\"easytip-text\"></div></div>");
