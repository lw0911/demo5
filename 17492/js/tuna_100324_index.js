...
$offset = function(a) {
    ...
    b[0] = a[0] + Math.round((c.scrollLeft - c.clientLeft) / d) - 15;
    return b
}) : ($offset = function(a) {
    if (!a) return null;
    $$.support.testCss();
...
(function() {
    ...
    f = {
        ...
        hotTemplate: {
            ...
            item: '<li><a href="###" data="{$data}" style="{$stylecolor}">{$text}</a></li>'
        },
        hotClassNames: {
