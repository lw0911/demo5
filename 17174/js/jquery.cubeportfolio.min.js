 ...
 *
 * version: 3.8.0 (19 September, 2020)
 * require: jQuery v1.7+
 *
 * Copyright 2013-2020, Mihai Buricea (http://scriptpie.com/cubeportfolio/live-preview/)
...
function(a, b, c, d) {
	...
	function(a, b, c, d) {
		...
		e.prototype.filterLayout = function() {
			function b() {
				c.wrapper[0].removeChild(d), c.$obj.removeClass("cbp-animation-" + c.options.animationType),
					c.filterFinish()
			}
			var c = this,
				d = c.$ul[0].cloneNode(!0);
	...
	function(a, b, c, d) {
		...
		var f = {
			...
			h = a(b);
		g["private"].lazyLoadScroll = new g["private"].publicEvents("scroll.lazyLoad", 50), e.prototype.loadImages = function() {
			var b = this,
		...
		var f = a.fn.cubeportfolio.constructor,
			g = {
				...
				updateSelfHostedVideo: function(a, b, c) {
					...
					f += 'Your browser does not support the video tag.</video><div class="cbp-popup-lightbox-bottom">' + (b ? '<div class="cbp-popup-lightbox-title">' + b + "</div>" : "") + c + "</div></div>",
						e.content.html(f), e.wrap.addClass("cbp-popup-ready"), e.preloadNearbyImages()
				},
				...
				close: function(c, d) {
					function e() {
						i.content.html(""), i.wrap.detach(), i.cubeportfolio.$obj.removeClass("cbp-popup-singlePageInline-open cbp-popup-singlePageInline-close"), "promise" === c && a.isFunction(d.callback) && d.callback.call(i.cubeportfolio)
					}
