...
function(e, n) {
	...
	e.fn.fullpage = function(W) {
		...
		function ge(o) {
			...
			if (W.autoScrolling && !En) {
				...
				var a = o.wheelDelta || -o.deltaY || -o.detail,
					...
					r = t.abs(o.wheelDeltaX) < t.abs(o.wheelDelta) || t.abs(o.deltaX) < t.abs(o.deltaY) || !l;
			...
			requestAnimFrame(function() {
				...
				if ("undefined" != typeof i) {
					...
					if (!(s.activeSection.is(n) && !qn || W.scrollBar && $.scrollTop() === s.dtop && !n.hasClass(k))) {
						if (s.activeSlide.length) var l = s.activeSlide.data("anchor"),
		...
		function Be() {
			if (!Nn && !W.lockAnchors) {
				var e = n.location.hash.replace("#", "").split("/"),
					...
					a = "undefined" == typeof An && "undefined" == typeof t && !Ln;
		...
		var An, kn, En, Ln = !1,
			Mn = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/),
			Bn = "ontouchstart" in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints,
			Rn = e(this),
			Fn = $.height(),
			qn = !1,
			zn = !0,
